...
export default function GMap({
  ...
  // Open external Google Maps / OpenStreetMap driving directions app link as required
  ...
  return (
    ...
    >
      ...
      <div 
        ref={mapContainerRef} 
        className="w-full h-full flex-1 z-0 cursor-pointer"
        onClick={(e) => !interactive && handleNavigate(e, "google")}
        title={!interactive ? "Click to open in Google Maps / get directions" : undefined}
      />
      ...
      {interactive ? (
        <div className="absolute bottom-3 left-3 right-3 z-[400] bg-rose-600/95 text-white py-2 px-3 rounded-2xl text-[10px] font-bold shadow-md flex items-center justify-between gap-2 backdrop-blur-xs animate-bounce pointer-events-none">
        ...
        <div className="absolute bottom-3 right-3 z-[400] flex flex-wrap gap-1.5 justify-end max-w-full px-2">
          ...
          <button
            ...
            title="Open driving directions in OpenStreetMap"
          >
