...
import { detectUserLocationWithReverseGeocode, formatLocationName } from "../utils/locationHelper";
                ...
                <>
                  {onStartChat && (
                    <button
                      ...
                      className={`w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-black text-xs uppercase tracking-wider shadow-xs transition-all active:scale-[0.98] cursor-pointer ${
                        selectedPart.sold
                    ...
                    >
                      ...
                      {selectedPart.sold ? t("soldOut") : "Contact Seller via In-App Chat"}
                    </button>
                  )}
                </>
              )}
