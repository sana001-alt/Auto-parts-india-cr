          ...
          <div className="space-y-5">
            ...
            <div className="bg-white p-5 rounded-2xl border border-slate-200/80 shadow-[0_2px_12px_rgba(11,18,32,0.04)] flex items-start justify-between gap-4">
              <div className="flex items-center gap-4 min-w-0">
                {/* Avatar Photo */}
                <div className="w-16 h-16 rounded-full overflow-hidden bg-slate-100 border-2 border-slate-200 shrink-0 shadow-sm flex items-center justify-center font-black text-slate-700 text-xl uppercase">
                  {avatarUrl ? (
                    <img 
                      src={avatarUrl} 
                      alt={displayName} 
                    ...
                    <div className="w-full h-full bg-gradient-to-tr from-indigo-600 to-sky-600 flex items-center justify-center font-black text-white text-xl">
                      {displayName ? displayName.substring(0, 2) : "SE"}
                    </div>
                  )}
                </div>
